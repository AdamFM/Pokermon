...
local blastoise={
  name = "blastoise", 
  pos = {x = 8, y = 0},
  config = {extra = {chips = 72, chip_mod = 32, hands = 3}},
  loc_vars = function(self, info_queue, center)
    type_tooltip(self, info_queue, center)
    info_queue[#info_queue+1] = {set = 'Other', key = 'mega_poke'}
		return {vars = {center.ability.extra.chips, center.ability.extra.chip_mod, center.ability.extra.hands}}
...
local raticate={
  name = "raticate", 
  pos = {x = 6, y = 1}, 
  config = {extra = {retriggers = 2, chips2 = 10}},
  loc_vars = function(self, info_queue, center)
    type_tooltip(self, info_queue, center)
...
local raichu={
  name = "raichu", 
  pos = {x = 12, y = 1}, 
  config = {extra={money = 2, threshold = 120, plus_slot = false, money_limit = 20}},
  loc_vars = function(self, info_queue, center)
    type_tooltip(self, info_queue, center)
